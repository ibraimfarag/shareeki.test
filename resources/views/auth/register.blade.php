...
<head>
   ...
   @php
      $version = '1.0.0'; 
      $timestamp_index = file_exists(public_path('main/css/pages/index.css')) ? filemtime(public_path('main/css/pages/index.css')) : time();
      $timestamp_reg = file_exists(public_path('main/css/pages/reg.css')) ? filemtime(public_path('main/css/pages/reg.css')) : time();
   @endphp
   <link rel="stylesheet" href="{{ asset('main/css/pages/index.css') }}?v={{ $version }}&t={{ $timestamp_index }}">
   <link rel="stylesheet" href="{{ asset('main/css/pages/reg.css') }}?v={{ $version }}&t={{ $timestamp_reg }}">
                  ...
                  <form method="POST" action="{{ route('register') }}" novalidate>
                     ...
                     <div class="mb-3" style="position: relative;">
                        ...
                        <div class="input-group flex-column flex-md-row flex-nowrap gap-2">
                           ...
                           <button type="button" class="btn btn-outline-primary mt-2 mt-md-0" id="send-code-btn">إرسال
                              كود
                              التفعيل</button>
                        </div>
                        @error('phone')
