               ...
               <div class="col-lg-6">
                  <div class="border border-radius-medium p-5">
                     <h3 class="h3 text-dark-heading mb-3">
                      ...
                      <form action="{{route('submit_contact_us')}}" method="post">
                          @csrf
                          <div class="f">
                              ...
                              <div class="needs_validation">
                                  ...
                                  <div class="form-floating  mb-3">
                                      <textarea name="body" class="form-control body"  id="body" cols="30" rows="7" placeholder="Write your notes or questions here..."></textarea>
