...
<!-- product block -->
                        ...
                        <div class="product-info--wrap border-bottom pb-3 mb-3">
                           <div class="product-info--item ">
                              <div class="product-date text-dark-content d-flex align-items-center">
                                 <svg class="fill-gold" xmlns="http://www.w3.org/2000/svg" height="18px"
                                 ...
                                 <strong class="d-inline-block ms-1">{{ date('d/m/Y',strtotime( $post->created_at ))  }}</strong>
                              </div>
                           ...
                           <div class="row">
                                 ...
                                 <div class="product-info--item d-flex">
                                    <div class="sm-icon">
                                       <svg class="fill-gold" xmlns="http://www.w3.org/2000/svg" height="24px"
                                          ...
                                          <path d="M5.88 19.75c0 1.1.9 2 2 2h1.45l-3.45-8.34v6.34z" /></svg>
                                    </div>
                                    <div class="ms-3">
                              ...
                              <div class="col-md-6 my-3">
                                 <div class="product-info--item d-flex">
                                    ...
                                    <div class="ms-3">
                                    @php $partner_sort = $post->partner_sort; $partner_sort = json_decode($partner_sort); $partner_sort = (array)$partner_sort;  @endphp
                  ...
                  <div class="col-lg-4 col-md-12">
                     <div class="personal-infos p-sticky">
                        <div class="card box-shadow-medium border-radius-medium overflow-hidden">
                           ...
                           <div class="card-body mt-2 p-4">
                              <div class="personal-info--item mb-4">
                                 ...
                                 <h5 class="h5 text-dark-content">{{  $post->user_id == 0 ? 'إدارة الموقع' : $post->user->name ?? ' '  }}</h5>
                              </div>
                              <div class="personal-info--item mb-4">
                                 <h4 class="h4 text-dark-heading">المنطقة</h4>
                                 <h5 class="h5 text-dark-content">{{ $post->area->name ?? 'غير محدد' }}-{{ $post->parentArea->name ?? 'غير محدد' }}</h5>
                              </div>
                              @guest
                             <a class="btn main-btn bg-blue-200 text-blue-light-heading border-none d-flex medium-btn
                              rounded align-items-center justify-content-center"
                                 data-bs-toggle="modal" data-bs-target="#needToSign">
                              ...
                              <a onclick="like()" class="btn main-btn bg-blue-200 text-blue-light-heading border-none d-flex medium-btn rounded align-items-center justify-content-center"
                        ...
                        <div class="text-center">
                           <button onclick="reportPost()" type="button" class="btn toast-btn main-btn text-red-heading text-btn medium-btn mt-2 rounded-btn" id="reportingAlert">
   ...
   <div class="position-fixed bottom-0 end-0 p-3" style="z-index: 5">
      <div class="toast align-items-center hide bg-success" id="reportingAlert" role="alert" aria-live="assertive" aria-atomic="true">
         <div class="d-flex">
      ...
      <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
            ...
            <div class="modal-body p-4 my-5 text-center">
               ...
               <a href="{{ asset('login') }}" type="button" class="btn main-btn gold-btn medium-btn rounded"> تسجيل الدخول </a>
