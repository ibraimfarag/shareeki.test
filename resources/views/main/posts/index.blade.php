...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
   ...
   @php
      ...
      $timestamp = file_exists(public_path('main/css/pages/index.css')) ? filemtime(public_path('main/css/pages/index.css')) : time();
   @endphp
<link rel="stylesheet" href="{{ asset('main/css/pages/index.css') }}?v={{ $version }}&t={{ $timestamp }}">
