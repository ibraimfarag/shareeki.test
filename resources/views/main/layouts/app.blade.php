            ...
            <div class="collapse navbar-collapse" id="navCollapse">
               <ul class="navbar-nav me-auto">
                  ...
                  <li class="nav-item hover-item rounded">
                     <a class="nav-link" href="{{ route('the_page', 'about') }}" data-scroll="about-us"
                        data-localize="menu.abouts">من
                        نحن</a>
                  </li>

                  <li class="nav-item hover-item rounded">
                     <a class="nav-link" href="{{ route('contact_us') }}" data-scroll="contact"
               ...
               <div class="d-flex flex-lg-row flex-md-column col-md-reverse">
                  <a href="{{ route('the_page', 'commission') }}"
         ...
         <div class="footer-wrap d-flex justify-content-between">
            ...
            <div class="footer-link-group mx-auto">
               <ul class="navbar-nav flex-wrap">
                  ...
                  <li class="nav-item">
                     <a class="nav-link text-white-heading" href="{{ route('the_page', 'about') }}"
