...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header text-center">إضافة إعلان جديد</h2>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('posts.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" id="the_icon">
                            <img src="{{ asset('adminpanel/img/upload.png') }}" style="width:120px;height:120px;margin: 16px 44.5%;background-color: black;" class="the_image_changing"  onclick="document.getElementById('image').click()" alt="Cinque Terre">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 text-right">
                                ...
                                <input type="checkbox" id="full_partnership" name="full_partnership" />
                                &nbsp;
                                شراكة 
                                &nbsp;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="PercEdit" type="text" placeholder="1.00%" class="form-control @error('partnership_percentage') is-invalid @enderror" name="partnership_percentage" value="{{ old('partnership_percentage') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="weeks_hours" type="number" class="form-control @error('weeks_hours') is-invalid @enderror" name="weeks_hours" value="{{ old('weeks_hours') }}" required autocomplete="weeks_hours" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="partners_no" type="number" class="form-control @error('partners_no') is-invalid @enderror" name="partners_no" value="{{ old('partners_no') }}" required autocomplete="partners_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="body" id="body" class="form-control @error('body') is-invalid @enderror textarea" cols="30" rows="10">{{ old('body') }}</textarea>
                        ...
                        {{--<div class="form-group row">
                            <label for="visible" class="col-md-3 col-form-label text-md-right">ظهور</label>
