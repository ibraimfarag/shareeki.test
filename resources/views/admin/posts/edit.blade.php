...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <h2 class="card-header text-center">التعديل على الإعلان {{ $post->title }}</h2>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('posts.update', $post->slug) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12" id="the_icon">
                            <img src="{{ $post->img_path }}" style="width:120px;height:120px;margin: 16px 44.5%;background-color: black;" class="the_image_changing"  onclick="document.getElementById('image').click()" alt="Cinque Terre">
                        ...
                        <div class="form-group row">
                            <label for="subcategories" class="col-md-3 col-form-label text-md-right">مجال الفرصة</label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9 text-right">
                                ...
                                {{--<select name="partner_sort" id="partner_sort" class="form-control @error('partner_sort') is-invalid @enderror">
                                ...
                                {{--<input type="checkbox"  name="partner_sort[]" />
                                &nbsp;
                                شراكة عائدات فقط
                                &nbsp;--}}


                                <input type="checkbox" id="full_partnership" name="full_partnership" @if(isset($post->partner_sort[0])) checked @endif />
                                &nbsp;
                                شراكة كاملة
                                &nbsp;
                                ...
                                <input type="checkbox" id="loan" name="loan" @if(isset($post->partner_sort[1])) checked @endif />
                                &nbsp;
                                تمويل قرض
                                &nbsp;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                 ...
                                 <input id="PercEdit" @if(key($post->partner_sort) == 1) disabled @endif type="text" placeholder="1.00%" value="{{ $post->partnership_percentage }}" class="form-control @error('partnership_percentage') is-invalid @enderror" name="partnership_percentage" value="{{ old('partnership_percentage') }}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="weeks_hours" type="number" class="form-control @error('weeks_hours') is-invalid @enderror" name="weeks_hours" value="{{ $post->weeks_hours }}" required autocomplete="weeks_hours" autofocus>
                                <label for="partner" style="float: right"><i class="fa fa-info-circle" aria-hidden="true"></i> اذا كنت ترغب بتفرغ الشريك</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{ $post->price }}" required autocomplete="price" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="partners_no" type="number"  class="form-control" name="partners_no" value="{{ $post->partners_no }}" required autocomplete="partners_no" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea name="body" id="body" class="form-control @error('body') is-invalid @enderror textarea" cols="30" rows="10">{{ $post->body }}</textarea>

                                <label for="partner" style="float: right"><i class="fa fa-info-circle" aria-hidden="true"></i> حديثك عن الفرصة أكثر يزيد من جاذبية الإعلان</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="phone"  class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $post->phone }}" required autocomplete="phone">
                        ...
                        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">إظهار البريد الإلكتروني</label>
                        
                            <div class="col-md-9">
                               
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="email" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">نعم</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="email" id="inlineRadio2" value="0">
                        ...
                        <div class="form-group row">
                            <label for="visible" class="col-md-3 col-form-label text-md-right">أضف مرفقات</label>
                            ...
                            <div class="col-md-9">
                                ...
                                <label for="partner" style="float: right"><i class="fa fa-info-circle" aria-hidden="true"></i>إضافة مرفقات مثل: دراسات جدوى, قوائم مالية, شكل لمنتج معين, أو تراخيص قانونية معينة من شأنها أن تزيد من جاذبية الإعلان!</label>
