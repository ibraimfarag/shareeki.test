                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="city"  class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" required autocomplete="city">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="date" id="birth_date"  class="form-control @error('birth_date') is-invalid @enderror" name="birth_date" value="{{ old('birth_date') }}" required autocomplete="birth_date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input type="number" id="max_budget"  class="form-control @error('max_budget') is-invalid @enderror" name="max_budget" value="{{ old('max_budget') }}" required autocomplete="max_budget">
