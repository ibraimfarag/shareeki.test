...
<head>
    ...
    <link href="{{ asset('admin/assets/libs/bootstrap-rating/bootstrap-rating.css') }}" rel="stylesheet"
        type="text/css">
...
<body data-sidebar="dark">
                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{ asset('admin/dashboard') }}" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('admin/images/' . $settings->minidashboard_logo) }}"
                                    onerror="this.src='{{asset('admin/images/default.png')}}'" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('admin/images/' . $settings->dashboard_logo) }}"
                                    onerror="this.src='{{asset('admin/images/default.png')}}'" alt="" height="17">
                            </span>
                        </a>
                        ...
                        <a href="{{ asset('admin/dashboard') }}" class="logo logo-light">
                            ...
                            <span class="logo-lg">
                                <img src="{{ asset('admin/images/' . $settings->dashboard_logo) }}"
                                    onerror="this.src='{{asset('admin/images/default.png')}}'" alt="" height="18">
                            </span>
                        </a>
                    </div>
                                            ...
                                            <div class="simplebar-content-wrapper"
                                                ...
                                                <div class="simplebar-content" style="padding: 0px;">
                                                    ...
                                                    @foreach($adminContact as $c)
                                                        <a href="{{url('admin/contacts/' . $c->id)}}"
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <small><i
                                                                            class="fa fa-clock-o"></i>{{ $c->created_at->diffForHumans() }}</small>
                                                                </div>
                                                            </div>
                                                        </a>
                                                    @endforeach
                    ...
                    <button type="button" class="btn btn-sm px-3 font-size-24 header-item waves-effect"
                        id="vertical-menu-btn">
                        <a class="btn btn-icon btn-circle btn-light" href="{{ asset('/') }}" target="_blank"
                            title="Shareeki">
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                ...
                                onerror="this.src='{{asset('admin/images/default.png')}}'"
                                alt="{{auth()->guard('admin')->user()->username}}">
                        </button>
                        <div class="dropdown-menu dropdown-menu-end ">
                            <a class="dropdown-item" href="{{ route('admins.edit', Auth::user()->user_name) }}"><i
                                    class="mdi mdi-account-circle font-size-17 text-muted align-middle me-1"></i> الصفحة
                                الشخصية</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item text-danger" href="{{asset('logout')}}"
                                onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                                    class="mdi mdi-power font-size-17 text-muted align-middle me-1 text-danger"></i>تسجيل
                                خروج</a>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{asset('admin/posts/type_enum/most_liked')}}"> كل الإعلانات الأكثر إعجاب
                                    </a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{asset('admin/posts/type_enum/most_disliked')}}"> كل الإعلانات الأكثر عدم
                                        إعجاب </a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{asset('admin/posts/type_enum/most_reported')}}"> كل الإعلانات الأكثر
                                        بلاغا </a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{asset('admin/posts/type_enum/blacklisted')}}"> كل الإعلانات المحظورة </a>
                                </li>
                            </ul>
                        </li>
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    @if(session()->has('error'))
                        <div style="text-align: center;font-size: large;" class="alert alert-icon text-center alert-danger"
                            role="alert">
                    ...
                    @if(session()->has('success'))
                        <div style="text-align:center;background-color:green;" class="alert alert-icon alert-success"
                            role="alert">
    ...
    <script
        src="{{ asset('admin/assets/libs/admin-resources/bootstrap-filestyle/bootstrap-filestyle.min.js') }} "></script>
